...
class DataStream{
 ...
 constructor(arrayBuffer, byteOffset, endianness) {
  ...
  this.position = 0;
  this.endianness = endianness == null ? this.LITTLE_ENDIAN : endianness;
};
...
/**
  ...
  @type {boolean}
  */
get BIG_ENDIAN(){return false};

/**
  Little-endian const to use as default endianness.
  @type {boolean}
  */
get LITTLE_ENDIAN(){return true};
...
mapInt32Array(length, e) {
  ...
  this.arrayToNative(arr, e == null ? this.endianness : e);
...
/**
  Reads an Int16Array of desired length and endianness from the this.
...
writeInt32Array(arr, e) {
  ...
  if (arr instanceof Int32Array &&
    ...
    this.memcpy(this._buffer, this.byteOffset+this.position,
                      arr.buffer, 0,
                      arr.byteLength);
 ...
 */
get endianness(){
   if(this._endianness === null){
    this._endianness = new Int8Array(new Int16Array([1]).buffer)[0] > 0;
   }
 ...
 */
arrayToNative(array, arrayIsLittleEndian) {
...
/**
  ...
  @return {Object} The converted typed array.
 */
nativeToEndian(array, littleEndian) {
 ...
 */
get failurePosition(){
  if(this._failurePosition === undefined){
    this._failurePosition = 0;
  }
  return this._failurePosition;
}
set failurePosition(v){
  this._failurePosition = v;
}
...
readUCS2String(length, endianness) {
  return this.createStringFromArray(this.readUint16Array(length, endianness));
};
...
readString(length, encoding) {
  if (encoding == null || encoding == "ASCII") {
    return this.createStringFromArray(this.mapUint8Array(length == null ? this.byteLength-this.position : length));
  } else {
...
readCString(length) {
  ...
  var s = this.createStringFromArray(this.mapUint8Array(i));
  if (length != null) {
    this.position += len-i;
  } else if (i != blen) {
...
readType(t, struct) {
  ...
  switch(t) {
    ...
    case 'uint16be':
      v = this.readUint16(this.BIG_ENDIAN); break;
    case 'int16be':
      v = this.readInt16(this.BIG_ENDIAN); break;
    case 'uint32be':
      v = this.readUint32(this.BIG_ENDIAN); break;
    case 'int32be':
      v = this.readInt32(this.BIG_ENDIAN); break;
    case 'float32be':
      v = this.readFloat32(this.BIG_ENDIAN); break;
    case 'float64be':
      v = this.readFloat64(this.BIG_ENDIAN); break;

    case 'uint16le':
      v = this.readUint16(this.LITTLE_ENDIAN); break;
    case 'int16le':
      v = this.readInt16(this.LITTLE_ENDIAN); break;
    case 'uint32le':
      v = this.readUint32(this.LITTLE_ENDIAN); break;
    case 'int32le':
      v = this.readInt32(this.LITTLE_ENDIAN); break;
    case 'float32le':
      v = this.readFloat32(this.LITTLE_ENDIAN); break;
    case 'float64le':
      v = this.readFloat64(this.LITTLE_ENDIAN); break;
    ...
    case 'u16stringle':
      v = this.readUCS2String(lengthOverride, this.LITTLE_ENDIAN); break;

    case 'u16stringbe':
      v = this.readUCS2String(lengthOverride, this.BIG_ENDIAN); break;
    ...
    default:
      if (t.length == 3) {
        ...
        if (typeof ta == "string") {
          ...
          var endianness = null;
          if (/le$/.test(ta)) {
            endianness = this.LITTLE_ENDIAN;
          } else if (/be$/.test(ta)) {
            endianness = this.BIG_ENDIAN;
          }
          if (len == '*') {
            length = null;
          }
...
writeType(t, v, struct) {
  ...
  switch(t) {
    ...
    case 'uint16be':
      this.writeUint16(v, this.BIG_ENDIAN);
      break;
    case 'int16be':
      this.writeInt16(v, this.BIG_ENDIAN);
      break;
    case 'uint32be':
      this.writeUint32(v, this.BIG_ENDIAN);
      break;
    case 'int32be':
      this.writeInt32(v, this.BIG_ENDIAN);
      break;
    case 'float32be':
      this.writeFloat32(v, this.BIG_ENDIAN);
      break;
    case 'float64be':
      this.writeFloat64(v, this.BIG_ENDIAN);
      break;

    case 'uint16le':
      this.writeUint16(v, this.LITTLE_ENDIAN);
      break;
    case 'int16le':
      this.writeInt16(v, this.LITTLE_ENDIAN);
      break;
    case 'uint32le':
      this.writeUint32(v, this.LITTLE_ENDIAN);
      break;
    case 'int32le':
      this.writeInt32(v, this.LITTLE_ENDIAN);
      break;
    case 'float32le':
      this.writeFloat32(v, this.LITTLE_ENDIAN);
      break;
    case 'float64le':
      this.writeFloat64(v, this.LITTLE_ENDIAN);
      break;
    ...
    case 'u16stringle':
      this.writeUCS2String(v, this.LITTLE_ENDIAN, lengthOverride);
      break;

    case 'u16stringbe':
      this.writeUCS2String(v, this.BIG_ENDIAN, lengthOverride);
      break;
